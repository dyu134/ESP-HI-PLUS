...
The ESP-HI-PLUS uses a two-stage detection system (analog ID resistor + I²C EEPROM metadata) to identify and configure attached sub-modules.

Detailed technical specifications for the identification protocol, class table, and EEPROM metadata can be found in the [Sub-modules directory](./Sub-modules/README.md).
...
See the [Sub-modules directory](./Sub-modules/README.md) for technical specifications and the full list of supported classes.
